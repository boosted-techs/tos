									...
									<div class="form-left-w3l">
										...
										<div class="form-right-w3ls ">
											...
											<div class="btnn">
												...
												<br>
												<div class="btnn">
												<button class="btn btn-info btn-fill" style="background-color:blue;"><a href="register.php">Register<a/></button>
												<br>
...
?>
									<p>&copy;2022 <?php echo $row['site_name']; ?> | Design by 
										<a href="http://www.lykup.com/Torrahclef" target="_blank">GROUP 9</a>
									</p>
	<?php } ?>
								</div> -->
